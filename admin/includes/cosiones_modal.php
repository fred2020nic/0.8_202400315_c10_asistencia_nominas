...
<!-- Modal para agregar nueva cosión -->
<div class="modal fade" id="addCosion" tabindex="-1" role="dialog" aria-labelledby="addCosionLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" method="POST" action="cosiones_add.php">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><b>Agregar Nueva Cosión</b></h4>
        </div>
...
<!-- Modal para editar cosión -->
<div class="modal fade" id="editCosion" tabindex="-1" role="dialog" aria-labelledby="editCosionLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" method="POST" action="cosiones_edit.php">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><b>Editar Cosión</b></h4>
        </div>
        <div class="modal-body">
          <input type="hidden" id="edit_cosion_id" name="id"> <!-- ID oculto de la cosión -->
          <!-- Selección de Empleado -->
          <div class="form-group">
...
<!-- Modal para eliminar cosión -->
<div class="modal fade" id="deleteCosion" tabindex="-1" role="dialog" aria-labelledby="deleteCosionLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" method="POST" action="cosiones_delete.php">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><b>Eliminar Cosión</b></h4>
        </div>
        <div class="modal-body">
          <input type="hidden" id="delete_cosion_id" name="id">
          <div class="text-center">
            <p>¿Estás seguro de eliminar esta cosión?</p>
