...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ocurrencias</li>
      </ol>
    </section>
    <!-- Main content -->
  ...
  <?php include 'includes/ocurrencia_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'ocurrencia_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('#ocuid').val(response.id);
      $('#edit_name').val(response.name);
      $('#edit_description').val(response.description);

      $('#del_ocuid').val(response.id);
      $('#del_ocurrencia').html(response.name);
    }
  });
}
</script>
